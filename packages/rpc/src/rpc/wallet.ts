...
export interface GetTransctionWithDecoded extends GetTransaction {
...
export type ImportDescriptors = Array<{
  success: boolean;
  warnings?: string[];
...
export interface SendManyVerbose {
...
export interface SendToAddressVerbose {
  // The transaction id for the send. Only 1 transaction is created regardless of
  // the number of addresses.
  txid: string;
  // The transaction fee reason.
